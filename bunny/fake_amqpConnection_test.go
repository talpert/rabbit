...
type FakeAmqpConnection struct {
	ChannelStub        func() (amqpChannel, error)
...
func (fake *FakeAmqpConnection) Channel() (amqpChannel, error) {
...
func (fake *FakeAmqpConnection) ChannelCalls(stub func() (amqpChannel, error)) {
	fake.channelMutex.Lock()
	defer fake.channelMutex.Unlock()
	fake.ChannelStub = stub
}

func (fake *FakeAmqpConnection) ChannelReturns(result1 amqpChannel, result2 error) {
	fake.channelMutex.Lock()
	defer fake.channelMutex.Unlock()
...
func (fake *FakeAmqpConnection) ChannelReturnsOnCall(i int, result1 amqpChannel, result2 error) {
	fake.channelMutex.Lock()
	defer fake.channelMutex.Unlock()
	fake.ChannelStub = nil
